    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_master_tb1 set full_name=@full_name, dob=@dob, contact_no=@contact_no, email=@email, country=@country, city=@city, postcode=@postcode, full_address=@full_address, password=@password, account_status=@account_status WHERE member_id='" + Session["username"].ToString().Trim() + "'", con);
